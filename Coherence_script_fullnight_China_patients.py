...
from My_functions_script_China import list_files_in_folder, preprocessing, bandpass_frequency_band, relative_power_for_frequencyband, coherence_features, extract_numbers_from_filename, extract_letters_and_numbers, hypnogram_average
        ...
        for label in labels_to_find:
            ...
            if label=='F3M2':
                ...
                if type(F3M2_index_trial)==int:
                    ...
                    #               file:restructuredfile_China_1161-psg.EDF_Electrode:O1M2
...
if 'Bandpower_values_6E_E1' in locals():
    ...
    BP_6E.to_csv(f"/scratch/users/s184063/China patients Features/Bandpower_Chinapatients_6electrodes.csv", index=False)
...
if 'Coherence_values_6E_E1E2' in locals():
    ...
    full_dataframe_6E.to_csv(f"/scratch/users/s184063/China patients Features/Coherence_Chinapatients_6electrodes.csv", index=False) # change filename using os
...
if 'Bandpower_values_5E_E1' in locals():
    ...
    BP_5E.to_csv(f"/scratch/users/s184063/China patients Features/Bandpower_Chinapatients_5electrodes.csv", index=False)
...
if 'Coherence_values_5E_E1E2' in locals():
    ...
    full_dataframe_5E.to_csv(f"/scratch/users/s184063/China patients Features/Coherence_Chinapatients_5electrodes.csv", index=False) # change filename using os
...
if 'Bandpower_values_4E_E1' in locals():
    ...
    BP_4E.to_csv(f"/scratch/users/s184063/China patients Features/Bandpower_Chinapatients_4electrodes.csv", index=False)
...
if 'Coherence_values_4E_E1E2' in locals():
    ...
    full_dataframe_4E.to_csv(f"/scratch/users/s184063/China patients Features/Coherence_Chinapatients_4electrodes.csv", index=False) # change filename using os
...
if 'Bandpower_values_3E_E1' in locals():
    ...
    BP_3E.to_csv(f"/scratch/users/s184063/China patients Features/Bandpower_Chinapatients_3electrodes.csv", index=False)
...
if 'Coherence_values_3E_E1E2' in locals():
    ...
    full_dataframe_3E.to_csv(f"/scratch/users/s184063/China patients Features/Coherence_Chinapatients_3electrodes.csv", index=False) # change filename using os
...
if 'Bandpower_values_2E_E1' in locals():
    ...
    BP_2E.to_csv(f"/scratch/users/s184063/China patients Features/Bandpower_Chinapatients_2electrodes.csv", index=False)
...
if 'Coherence_values_2E_E1E2' in locals():
    ...
    full_dataframe_2E.to_csv(f"/scratch/users/s184063/China patients Features/Coherence_Chinapatients_2electrodes.csv", index=False) # change filename using os
