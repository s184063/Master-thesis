...
# File paths 
input_path =r'/scratch/users/s184063/China restructured EDF controls correct/' # RBD_Restructure_firsttry # select correct path and folder
#input_path = r'/scratch/users/s184063/China controls subsample/'

input_path_hypnodensities =r'/scratch/users/s184063/hypnograms_China_controls/'
...
Outlier_path=r'/scratch/users/s184063/China controls Features/Outliers_China_controls.csv'

# Loading list with outliers 
if os.path.exists(Outlier_path):
    Outliers=pd.read_csv('/scratch/users/s184063/China controls Features/Outliers_China_controls.csv')
...
if 'Bandpower_values_6E_E1' in locals():
    ...
    BP_6E.to_csv(f"/scratch/users/s184063/China controls Features/Bandpower_Chinacontrols_4partnight_6electrodes.csv", index=False)
...
if 'Coherence_values_6E_E1E2' in locals():
    ...
    full_dataframe_6E.to_csv(f"/scratch/users/s184063/China controls Features/Coherence_Chinacontrols_4partnight_6electrodes.csv", index=False) # change filename using os
...
if 'Bandpower_values_5E_E1' in locals():
    ...
    BP_5E.to_csv(f"/scratch/users/s184063/China controls Features/Bandpower_Chinacontrols_4partnight_5electrodes.csv", index=False)
...
if 'Coherence_values_5E_E1E2' in locals():
    ...
    full_dataframe_5E.to_csv(f"/scratch/users/s184063/China controls Features/Coherence_Chinacontrols_4partnight_5electrodes.csv", index=False) # change filename using os
...
if 'Bandpower_values_4E_E1' in locals():
    ...
    BP_4E.to_csv(f"/scratch/users/s184063/China controls Features/Bandpower_Chinacontrols_4partnight_4electrodes.csv", index=False)
...
if 'Coherence_values_4E_E1E2' in locals():
    ...
    full_dataframe_4E.to_csv(f"/scratch/users/s184063/China controls Features/Coherence_Chinacontrols_4partnight_4electrodes.csv", index=False) # change filename using os
...
if 'Bandpower_values_3E_E1' in locals():
    ...
    BP_3E.to_csv(f"/scratch/users/s184063/China controls Features/Bandpower_Chinacontrols_4partnight_3electrodes.csv", index=False)
...
if 'Coherence_values_3E_E1E2' in locals():
    ...
    full_dataframe_3E.to_csv(f"/scratch/users/s184063/China controls Features/Coherence_Chinacontrols_4partnight_3electrodes.csv", index=False) # change filename using os
...
if 'Bandpower_values_2E_E1' in locals():
    ...
    BP_2E.to_csv(f"/scratch/users/s184063/China controls Features/Bandpower_Chinacontrols_4partnight_2electrodes.csv", index=False)
...
if 'Coherence_values_2E_E1E2' in locals():
    ...
    full_dataframe_2E.to_csv(f"/scratch/users/s184063/China controls Features/Coherence_Chinacontrols_4partnight_2electrodes.csv", index=False) # change filename using os
