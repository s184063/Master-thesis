...
from My_functions_script_China import list_files_in_folder, extract_numbers_from_filename, extract_letters_and_numbers, split_string_by_length
...
# File paths 
input_path =r"/oak/stanford/groups/mignot/psg/CNC_China/PSG_controls_2023/" # select correct path and folder
#input_path =r"/oak/stanford/groups/mignot/psg/CNC_China/PSG_2022/" # select correct path and folder
...
for edf_file in edf_files_list:
    ...
    try:
        ...
        signals_uploaded, signal_headers, header = plib.highlevel.read_edf(edf_file)

        signals=copy.deepcopy(signals_uploaded)
        ...
        output_path=r'/scratch/users/s184063/China restructured EDF controls correct/' 
        filename=f'restructuredfile_China_{patientID}.EDF'
        ...
        labels_to_find = ['F3-A2','F4-A1','C3-A2','C4-A1', 'O1-A2','O2-A1','EEG F3-A2','EEG F4-A1','EEG C3-A2','EEG C4-A1', 'EEG O1-A2','EEG O2-A1']
        ...
        for label in labels_to_find:
            ...
            if label=='F3-A2' or label=='EEG F3-A2':
            ...
            # Extracting the electrode indexes 
            if label=='F4-A1' or label=='EEG F4-A1':
            ...
            # Extracting the electrode indexes 
            if label=='C3-A2' or label=='EEG C3-A2':
            ...
            # Extracting the electrode indexes 
            if label=='C4-A1' or label=='EEG C4-A1':
            ...
            # Extracting the electrode indexes 
            if label=='O2-A1' or label=='EEG O2-A1':
            ...
            # Extracting the electrode indexes 
            if label=='O1-A2' or label=='EEG O1-A2':
        ...
        # Deleting variables to not mix controls 
