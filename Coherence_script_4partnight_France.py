...
from My_functions_script_France import list_files_in_folder, preprocessing, bandpass_frequency_band, relative_power_for_frequencyband, coherence_features, extract_numbers_from_filename, extract_letters_and_numbers, hypnogram_average
...
# File paths 
input_path =r'/scratch/users/s184063/France restructure EDF all correct final/' # France restructure EDF all correct final #select correct path and folder
input_path_hypnodensities =r'/scratch/users/s184063/hypnograms_France_all_correct_final/'
...
Outliers=pd.read_csv('/scratch/users/s184063/France_Features/Outliers_France.csv')
...
for edf_file in edf_files_list:
    ...
    try:
        ...
        patientID=filename[28:] #restructuredfile_France_all_050216AA
        print(patientID)
        ...
        for label in labels_to_find:
            ...
            if label=='F3M2':
                ...
                if type(F3M2_index_trial)==int:
                    ...
                    #               file:restructuredfile_France_all_060509ga.EDF_Electrode:O2M1
                    check_outlier=f'file:restructuredfile_France_all_{patientID}.EDF_Electrode:F3M2'
                    print(check_outlier)
                    ...
                    for g in range(len(Bad_channels)):
                        if check_outlier == Bad_channels[g]:
                            ...
                            print(f"file:restructuredfile_France_all_'{patientID}'.EDF_Electrode:F3M2")
            ...
            if label=='F4M1':
                ...
                if type(F4M1_index_trial)==int:
                    ...
                    check_outlier=f'file:restructuredfile_France_all_{patientID}.EDF_Electrode:F4M1'
                    print(check_outlier)
                    print(type(check_outlier))
                    ...
                    for g in range(len(Bad_channels)):
                        if check_outlier == Bad_channels[g]:
                            ...
                            print('Channel generated')
                            print(f"file:restructuredfile_France_all_'{patientID}'.EDF_Electrode:F4M1")
            ...
            if label=='C3M2':
                ...
                if type(C3M2_index_trial)==int:
                    ...
                    check_outlier=f'file:restructuredfile_France_all_{patientID}.EDF_Electrode:C3M2'
                    print(check_outlier)
                    print(type(check_outlier))
                    ...
                    for g in range(len(Bad_channels)):
                        if check_outlier == Bad_channels[g]:
                            ...
                            print('Channel generated')
                            print(f"file:restructuredfile_France_all_'{patientID}'.EDF_Electrode:C3M2")
            ...
            if label=='C4M1':
                ...
                if type(C4M1_index_trial)==int:
                    ...
                    check_outlier=f'file:restructuredfile_France_all_{patientID}.EDF_Electrode:C4M1'
                    print(check_outlier)
                    print(type(check_outlier))
                    ...
                    for g in range(len(Bad_channels)):
                        if check_outlier == Bad_channels[g]:
                            ...
                            print('Channel generated')
                            print(f"file:restructuredfile_France_all_'{patientID}'.EDF_Electrode:C4M1")
            ...
            if label=='O2M1':
                ...
                if type(O2M1_index_trial)==int:
                    ...
                    check_outlier=f'file:restructuredfile_France_all_{patientID}.EDF_Electrode:O2M1'
                    print(check_outlier)
                    print(type(check_outlier))
                    ...
                    for g in range(len(Bad_channels)):
                        if check_outlier == Bad_channels[g]:
                            ...
                            print('Channel generated')
                            print(f"file:restructuredfile_France_all_'{patientID}'.EDF_Electrode:O2M1")
            ...
            if label=='O1M2':
                ...
                if type(O1M2_index_trial)==int:
                    ...
                    check_outlier=f'file:restructuredfile_France_all_{patientID}.EDF_Electrode:O1M2'
                    print(check_outlier)
                    print(type(check_outlier))
                    ...
                    for g in range(len(Bad_channels)):
                        if check_outlier == Bad_channels[g]:
                            ...
                            print('Channel generated')
                            print(f"file:restructuredfile_France_all_'{patientID}'.EDF_Electrode:O1M2")
        ...
        elif 'C3M2_index' in locals() and 'O2M1_index' in locals(): 
                    
            print('The combination: C3M2, O2M1 exists ')

            # Stacking values having a specific order (frontal, central, occipital)
            Electrodes=['C3M2','O2M1']
            Signals=np.vstack((C3M2_signal,O2M1_signal))
            Signal_headers = [C3M2_signalheader,O2M1_signalheader]

            del C3M2_index,O2M1_index

        elif 'C4M1_index' in locals() and 'O1M2_index' in locals(): 
                    
            print('The combination: C4M1, O1M2 exists ')

            # Stacking values having a specific order (frontal, central, occipital)
            Electrodes=['C4M1','O1M2']
            Signals=np.vstack((C4M1_signal,O1M2_signal))
            Signal_headers = [C4M1_signalheader,O1M2_signalheader]

            del C4M1_index,O1M2_index

        elif 'C3M2_index' in locals() and 'O1M2_index' in locals(): 
                    
            print('The combination: C3M2, O1M2 exists ')

            # Stacking values having a specific order (frontal, central, occipital)
            Electrodes=['C3M2','O1M2']
            Signals=np.vstack((C3M2_signal,O1M2_signal))
            Signal_headers = [C3M2_signalheader,O1M2_signalheader]

            del C3M2_index,O1M2_index
        ...
        for loop_factor in range(len(Electrodes)): 
            ...
            time_filtered_HP_single=quarter_4
        ...
        shortening_hypnogram=hypnogram[3*quarter_length_hypnogram:4*quarter_length_hypnogram]
        ...
        for d in range(len(E_combinations)):
            ...
            quarter_4=time_filtered_HP_chan1[3*quarter_length:4*quarter_length]
            time_filtered_HP_chan1=quarter_4

            quarter_44=time_filtered_HP_chan2[3*quarter_length:4*quarter_length]
            time_filtered_HP_chan2=quarter_44
...
if 'Bandpower_values_6E_E1' in locals():
    ...
    BP_6E.to_csv(f"/scratch/users/s184063/France_Features/Bandpower_France_4partnight_6electrodes.csv", index=False)
...
if 'Coherence_values_6E_E1E2' in locals():
    ...
    full_dataframe_6E.to_csv(f"/scratch/users/s184063/France_Features/Coherence_France_4partnight_6electrodes.csv", index=False) # change filename using os
...
if 'Bandpower_values_5E_E1' in locals():
    ...
    BP_5E.to_csv(f"/scratch/users/s184063/France_Features/Bandpower_France_4partnight_5electrodes.csv", index=False)
...
if 'Coherence_values_5E_E1E2' in locals():
    ...
    full_dataframe_5E.to_csv(f"/scratch/users/s184063/France_Features/Coherence_France_4partnight_5electrodes.csv", index=False) # change filename using os
...
if 'Bandpower_values_4E_E1' in locals():
    ...
    BP_4E.to_csv(f"/scratch/users/s184063/France_Features/Bandpower_France_4partnight_4electrodes.csv", index=False)
...
if 'Coherence_values_4E_E1E2' in locals():
    ...
    full_dataframe_4E.to_csv(f"/scratch/users/s184063/France_Features/Coherence_France_4partnight_4electrodes.csv", index=False) # change filename using os
...
if 'Bandpower_values_3E_E1' in locals():
    ...
    BP_3E.to_csv(f"/scratch/users/s184063/France_Features/Bandpower_France_4partnight_3electrodes.csv", index=False)
...
if 'Coherence_values_3E_E1E2' in locals():
    ...
    full_dataframe_3E.to_csv(f"/scratch/users/s184063/France_Features/Coherence_France_4partnight_3electrodes.csv", index=False) # change filename using os
...
if 'Bandpower_values_2E_E1' in locals():
    ...
    BP_2E.to_csv(f"/scratch/users/s184063/France_Features/Bandpower_France_4partnight_2electrodes.csv", index=False)
...
if 'Coherence_values_2E_E1E2' in locals():
    ...
    full_dataframe_2E.to_csv(f"/scratch/users/s184063/France_Features/Coherence_France_4partnight_2electrodes.csv", index=False) # change filename using os
