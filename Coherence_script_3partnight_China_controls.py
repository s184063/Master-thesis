...
if 'Bandpower_values_6E_E1' in locals():
    ...
    BP_6E.to_csv(f"/scratch/users/s184063/China controls Features/Bandpower_Chinacontrols_3partnight_6electrodes.csv", index=False)
...
if 'Coherence_values_6E_E1E2' in locals():
    ...
    full_dataframe_6E.to_csv(f"/scratch/users/s184063/China controls Features/Coherence_Chinacontrols_3partnight_6electrodes.csv", index=False) # change filename using os
...
if 'Bandpower_values_5E_E1' in locals():
    ...
    BP_5E.to_csv(f"/scratch/users/s184063/China controls Features/Bandpower_Chinacontrols_3partnight_5electrodes.csv", index=False)
...
if 'Coherence_values_5E_E1E2' in locals():
    ...
    full_dataframe_5E.to_csv(f"/scratch/users/s184063/China controls Features/Coherence_Chinacontrols_3partnight_5electrodes.csv", index=False) # change filename using os
...
if 'Bandpower_values_4E_E1' in locals():
    ...
    BP_4E.to_csv(f"/scratch/users/s184063/China controls Features/Bandpower_Chinacontrols_3partnight_4electrodes.csv", index=False)
...
if 'Coherence_values_4E_E1E2' in locals():
    ...
    full_dataframe_4E.to_csv(f"/scratch/users/s184063/China controls Features/Coherence_Chinacontrols_3partnight_4electrodes.csv", index=False) # change filename using os
...
if 'Bandpower_values_3E_E1' in locals():
    ...
    BP_3E.to_csv(f"/scratch/users/s184063/China controls Features/Bandpower_Chinacontrols_3partnight_3electrodes.csv", index=False)
...
if 'Coherence_values_3E_E1E2' in locals():
    ...
    full_dataframe_3E.to_csv(f"/scratch/users/s184063/China controls Features/Coherence_Chinacontrols_3partnight_3electrodes.csv", index=False) # change filename using os
...
if 'Bandpower_values_2E_E1' in locals():
    ...
    BP_2E.to_csv(f"/scratch/users/s184063/China controls Features/Bandpower_Chinacontrols_3partnight_2electrodes.csv", index=False)
...
if 'Coherence_values_2E_E1E2' in locals():
    ...
    full_dataframe_2E.to_csv(f"/scratch/users/s184063/China controls Features/Coherence_Chinacontrols_3partnight_2electrodes.csv", index=False) # change filename using os
