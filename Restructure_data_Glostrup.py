...
# File paths 
input_path =r"/oak/stanford/groups/mignot/psg/DHC_Glostrup/DNC_Glostrup/" # select correct path and folder
...
for edf_file in edf_files_list:
    ...
    try:
        ...
        output_path=r'/scratch/users/s184063/Glostrup_Restructure_firsttry/N0020.EDF' 
        filename=f'restructuredfile_Glostrup_{patientID}.EDF'
        ...
        labels_to_find = ['F3-A1','F4-A1','C3-A2','C4-A1', 'O1-A2','O2-A1']
